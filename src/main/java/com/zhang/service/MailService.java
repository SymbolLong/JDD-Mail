...
public class MailService {
    ...
    public static String myEmailAccount = "zhangshenglong@yscredit.com";
    public static String myEmailPassword = "AL3-r6X-5pR-vJB";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("E://timg.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("E://neo4j.txt"));  // 读取本地文件
