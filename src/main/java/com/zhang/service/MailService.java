...
public class MailService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("877857078@qq.com", "张圣龙", "UTF-8"));

        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("zhangshenglong@yscredit.com", "张有数", "UTF-8"));
        //    To: 增加收件人（可选）
